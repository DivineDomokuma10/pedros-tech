export const contactConfig = {
  ...
  social: {
    twitter:
      process.env.NEXT_PUBLIC_TWITTER || "https://twitter.com/pedrostech",
    linkedin:
      process.env.NEXT_PUBLIC_LINKEDIN ||
      "https://linkedin.com/company/pedrostech",
    telegram: process.env.NEXT_PUBLIC_TELEGRAM || "https://t.me/pedrostech",
    instagram:
      process.env.NEXT_PUBLIC_INSTAGRAM || "https://instagram.com/pedrostech",
    xhandle: process.env.NEXT_PUBLIC_GITHUB || "https://github.com/pedrostech",
  },
  company: {
    name: "Pedro's Tech",
